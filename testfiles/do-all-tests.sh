# non-parallel 16 sequence test, ribotyper and riboaligner
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.example-16 test1
# parallel 16 sequence test, ribotyper and riboaligner
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.p.example-16 test2
# non-parallel 16 sequence test, ribosensor
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.rs.example-16 test3

# non-parallel 100 sequence test, ribotyper and riboaligner
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.r100 test4
# parallel 100 sequence test, ribotyper and riboaligner
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.p.r100 test5
# non-parallel 100 sequence test, ribosensor
$RIBODIR/ribotest.pl -f $RIBODIR/testfiles/testin.rs.r100 test6
