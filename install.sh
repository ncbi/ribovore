...
echo "export RIBOINFERNALDIR=\"\$RIBODIR\"/bin"
echo "export RIBOEASELDIR=\"\$RIBODIR\"/bin"
echo "export RIBOTIMEDIR=/usr/bin"
echo "export SENSORDIR=\"\$RIBODIR\"/rRNA_sensor-$RVERSION"
echo "export EPNOPTDIR=\"\$RIBODIR\"/epn-options-$RVERSION"
echo "export EPNOFILEDIR=\"\$RIBODIR\"/epn-ofile-$RVERSION"
echo "export EPNTESTDIR=\"\$RIBODIR\"/epn-test-$RVERSION"
...
echo "setenv RIBOINFERNALDIR \"\$RIBODIR\"/bin"
echo "setenv RIBOEASELDIR \"\$RIBODIR\"/bin"
echo "setenv RIBOTIMEDIR /usr/bin"
echo "setenv SENSORDIR \"\$RIBODIR\"/rRNA_sensor-$RVERSION"
echo "setenv EPNOPTDIR \"\$RIBODIR\"/epn-options-$RVERSION"
echo "setenv EPNOFILEDIR \"\$RIBODIR\"/epn-ofile-$RVERSION"
echo "setenv EPNTESTDIR \"\$RIBODIR\"/epn-test-$RVERSION"
