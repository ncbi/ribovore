...
echo "export SENSORDIR=\"\$RIBODIR\"/rRNA_sensor"
echo "export EPNOPTDIR=\"\$RIBODIR\"/epn-options"
echo "export EPNOFILEDIR=\"\$RIBODIR\"/epn-ofile"
echo "export EPNTESTDIR=\"\$RIBODIR\"/epn-test"
...
echo "setenv SENSORDIR \"\$RIBODIR\"/rRNA_sensor"
echo "setenv EPNOPTDIR \"\$RIBODIR\"/epn-options"
echo "setenv EPNOFILEDIR \"\$RIBODIR\"/epn-ofile"
echo "setenv EPNTESTDIR \"\$RIBODIR\"/epn-test"
