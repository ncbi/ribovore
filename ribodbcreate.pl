...
push(@column_explanation_A, "# Column 4: 'taxid':   taxid of sequence (species level)\n");
push(@column_explanation_A, "# Column 5: 'gtaxid':  taxid of sequence ($level level)\n");
