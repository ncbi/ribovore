...
echo "Downloading Infernal dev version src distribution"
git clone https://github.com/EddyRivasLab/infernal
cd infernal
git checkout develop
git clone https://github.com/EddyRivasLab/hmmer
(cd hmmer; git checkout develop)
...
echo "export RIBOINFERNALDIR=\"\$RIBOINSTALLDIR/infernal/src\""
echo "export RIBOEASELDIR=\"\$RIBOINSTALLDIR/infernal/easel/miniapps\""
...
echo "setenv RIBOINFERNALDIR \"\$RIBOINSTALLDIR/infernal/src\""
echo "setenv RIBOEASELDIR \"\$RIBOINSTALLDIR/infernal/easel/miniapps\""
